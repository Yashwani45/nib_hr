...
const HumanResources = ({ records, dbData }) => {
  ...
  const deptDetail = records?.[0] || {
    ...
    description: "Handles employee onboarding, attendance, leave, payroll coordination, recruitment and HR operations for the Indore branch.",
    status: "Active"
  };
