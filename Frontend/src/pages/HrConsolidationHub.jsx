...
// AssetAllocationDashboard is imported from ../components/Assets/AssetAllocationDashboard
...
const HrConsolidationHub = () => {
  ...
  const renderTabDashboard = (tabName) => {
    ...
    if (tabName === "Asset Dashboard") {
      return <AssetAllocationDashboard records={dbData["Asset Allocation"] || dbData["asset_allocations"] || []} dbData={dbData} onRefreshData={fetchAllData} />;
    }
